...
export default function Layout({
  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-between bg-stone-900">
      <header className="w-full flex flex-col md:flex-row px-10 py-6 border-b border-white/50 justify-center items-center md:justify-start md:items-center gap-8">
        <Link
          href={"/"}
        ...
        <div className="relative w-full md:w-1/2 rounded-full">
      ...
      <section className="w-full p-10 md:px-20 flex flex-col justify-center items-start gap-6">
        {children}
      </section>
